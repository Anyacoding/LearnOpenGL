 ...
 *  is specified.
 *
 *  If you only wish to updateRotate the resolution of a full screen window or the
 ...
 *  a joystick shaderProgramID, as they all check for presence before performing any other
 *  work.
 *
