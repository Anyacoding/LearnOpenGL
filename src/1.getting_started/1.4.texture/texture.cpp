...
//--------------------------------------------------------------------------------------------------------//
    ...
    unsigned char *data = stbi_load("../src/1.getting_started/1.4.texture/container.jpg", &width, &height, &nrChannels, 0);
    ...
    // 读入纹理src
    stbi_set_flip_vertically_on_load(true);
    data = stbi_load("../src/1.getting_started/1.4.texture/awesomeface.png", &width, &height, &nrChannels, 0);
